...
//=================== COMMENTED OUT AS IT CONFLICTS WITH /grades/stats ==================================================
...
// Create an Validator for existing Grades collection
async () => {
  await db.command({
    collMod: "grades",
      ...
      $jsonSchema: {
        ...
        properties: {
          class_id: {
            ...
            description: "'class_id' is required, and must be a int",
          },
          learn_er_id: {
            bsonType: "int",
            min: { $gte: 0 },
            description: "'learner_id' is required and must be a int",
          },
        },
      },
    },
